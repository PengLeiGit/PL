...
public class PLRoute: NSObject {
    ...
    public func perform(_ targetName: String, params: [String: Any]?, nameSpace: String = Bundle.main.infoDictionary!["CFBundleExecutable"] as! String, shouleCacheTarget: Bool) -> Any? {
